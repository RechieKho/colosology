...
namespace General.Operation.Audio
{
    public class ZonalAudioManager
    {
        ...
        #region Method
        // Constructor
        public ZonalAudioManager(ZonalAudioRegistry registry, string name, GameObject __gameObject)
        {
        ...
        public void AssignAudio(ZonalAudioRegistry registry, string name)
        {
            // assign mixer group
