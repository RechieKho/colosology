...
namespace General.Data.TwnDest
{
    // These classes will act as a Dictionary to save destinations

    public abstract class TwnDestData
    {
        #region Variable
    ...
    public class TwnColorData : TwnDestData
    {
        /// <summary>
        /// TwnColorData is use to store color for sprites (3D object is not included)
        ...
        #region Methods
        // constructor
        public TwnColorData(GameObject __target, Color __origin, string __key, Color __color, TargetType __targetType, float __time, LeanTweenType __tweenType, bool __ignoreTimeScale = true, CallBack __callback = null)
        {
            callBack = __callback;
    ...
    public class TwnNormData : TwnDestData
    {
        /// <summary>
        /// TwnNormData is use to store Vector2 points
        /// </summary>
        ...
        #region Methods
        // constructor
        public TwnNormData(GameObject __target, Vector3 __origin, string __key, Vector3 __vector2, float __time, LeanTweenType __tweenType, bool __ignoreTimeScale = true, CallBack __callBack = null)
        {
            callBack = __callBack;
            ignoreTimeScale = __ignoreTimeScale;
            target = __target;
