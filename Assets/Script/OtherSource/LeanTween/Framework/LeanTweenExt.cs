...
public static class LeanTweenExt
{
    ...
    //LeanTween.colorTMP_Text
    public static LTDescr LeanColorTMP_Text(this RectTransform rectTransform, Color to, float time) { return LeanTween.colorTMP_Text(rectTransform, to, time); }
